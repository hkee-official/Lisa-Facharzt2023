...
const config: DocsThemeConfig = {
  logo:(
    <> 
    <span className='flex'><svg className="pr-4" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg><span style={{ fontSize: '1.2rem', marginLeft: '.5em', top: '11px', position: 'relative' }}>
        Facharzt Jannis
      </span></span></>),
  project: {
  ...
  docsRepositoryBase: 'https://github.com/hkee-official/Lisa-Facharzt2023/tree/main/',
  footer: {
